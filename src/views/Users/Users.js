...
const Users = (props) => {
    ...
    useEffect(()=>{
        if(props.user.upsertUserAuth){
            setLoader(true)
            console.log('upsertUserAuth: ',props.user)
    ...
    const getUser = async (userId) => {
        ...
        if (userData){
            console.log('EditImage: ',userData)
            setUser({ ...userData })
    ...
    const submit = (Id) => {
        console.log('iD: ',Id , ' modalType: ',modalType)
        let check = true 
        ...
        if (check) {
            ...
            if (modalType === 3) { // add modal type
                console.log('editUserPayload: ',payload)
    ...
    useEffect(()=>{
        if(searchAtFrom){
            console.log("SearchAtFrom: ",searchAtFrom)
